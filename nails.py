...
colors = ["Red", "Pink", "Orange", "Yellow", "Green", "Blue", "Purple", "Black", "White", "Silver", "Gold"]
designs = ["Floral", "French tips", "Wiggly lines", "Glitter", "3D texture", "Hearts", "Jewels", "Animal print"]
